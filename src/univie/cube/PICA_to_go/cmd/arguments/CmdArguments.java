...
public abstract class CmdArguments {
	...
	public void setTranslationTable(String translationTable) {
		if(! translationTable.matches("\\d+")) throw new RuntimeException("Wrong argument (no number or negative number) for translation table");
		if(Integer.parseInt(translationTable) > 25 || Integer.parseInt(translationTable) == 0) throw new RuntimeException("Only translation tables 1 to 25 are supported");
